...
public class CommonUtil {
    ...
    */
    ...
    public static float getDistance(String distance) {
        ...
        String[] dateItemArray = distance.split(" ");
        String km = dateItemArray[1];
    ...
    public static String getDateToDisplay(String date) {

        String day1 = "";
        String month1 = "";

        String[] dateItemArray = date.split("-");

        String dd = dateItemArray[2];
        String mm = dateItemArray[1];
        String yy = dateItemArray[0];

        int selDay = Integer.parseInt(dd);
        int selMonth = Integer.parseInt(mm);
