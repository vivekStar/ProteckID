...
public class CategorySpinnerAdapter extends BaseAdapter {
    ...
    private List<Category> stringArrayList;

    public CategorySpinnerAdapter(Context context, List<Category> stringArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        _tv_title.setText(stringArrayList.get(position).getCategoryName());
