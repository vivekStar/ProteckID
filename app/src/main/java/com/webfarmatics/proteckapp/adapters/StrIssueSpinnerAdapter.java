...
public class StrIssueSpinnerAdapter extends BaseAdapter {

    private Context context;
    private List<StrIssue> stringArrayList;

    public StrIssueSpinnerAdapter(Context context, List<StrIssue> stringArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        _tv_title.setText(stringArrayList.get(position).getIssueName());
